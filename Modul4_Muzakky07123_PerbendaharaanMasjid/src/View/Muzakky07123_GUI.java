...
public class Muzakky07123_GUI {
    ...
    public Muzakky07123_GUI() {
        ...
        viewpnglrn.addActionListener(new ActionListener()
        {
            @Override
            public void actionPerformed (ActionEvent ae) {
                MRA.dispose();
                Muzakky07123_ViewPengeluaranGUI ViewPengeluaranGUI = new Muzakky07123_ViewPengeluaranGUI();
            }
        });
        ...
        saldo.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed (ActionEvent ae) {
                MRA.dispose();
                Muzakky07123_SaldoGUI SaldoGUI = new Muzakky07123_SaldoGUI();
            }
        });
        ...
        update.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed (ActionEvent ae) {
                MRA.dispose();
                Muzakky07123_UpdateGUI UpdateGUI = new Muzakky07123_UpdateGUI();
            }
        });
        ...
        delete.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed (ActionEvent ae) {
                MRA.dispose();
                Muzakky07123_DeleteGUI DeleteGUI = new Muzakky07123_DeleteGUI();
            }
        });
    }
